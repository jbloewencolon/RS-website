...
**Suggested implementation order, as given:** ~~RS-042~~ → ~~RS-043~~ → ~~RS-044~~ → ~~RS-045~~ → RS-046 → RS-047/RS-048 if time permits. RS-042 through RS-045 shipped, see `completed.tasks.md`.
